...
public class SimpleDigital {
     ...
     */
    public SimpleDigital(Context pi4j, PIN address, DigitalState initial) {
        this.digitalOutput = pi4j.create(buildDigitalOutputConfig(pi4j, address, initial));
    }
     ...
     */
    protected DigitalOutputConfig buildDigitalOutputConfig(Context pi4j, PIN address, DigitalState initial) {
